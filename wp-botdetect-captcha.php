...
/*  Copyright 2013  Lanapsoft Inc.  (email : development@lanapsoft.com)
...
Plugin URI: http://captcha.com/doc/php/wordpress-captcha.html
...
$LBD_WP_Defaults['library_path'] = __DIR__ . '/lib/';
...
class WP_Botdetect_Plugin{
	...
	function captcha_library_missing_notice(){
	  echo '<div class="error"><p>' . sprintf(__( 'The local captcha library could not be found at the path "%s". Please <a href="http://captcha.com/captcha-download.html?version=php" title="Download the BotDetect PHP CAPTCHA Library">download</a> the Botdetect PHP Captcha Library and deploy it to your server. Make sure that the specified path points to the downloaded "lib" directory.', 'botdetect'), $this->options['library_path']) . '</p></div>';
	}
  
  

	function captcha_service_notice(){
	  echo '<div class="updated"><p>' . __( 'The BotDetect Captcha service is currently in closed Alpha testing phase. Pleaso contact us if you wish to participate in testing.', 'botdetect') . '</p></div>';
	}
	...
	public function plugin_action_links( $links, $file ) {
		...
		if ( $file == plugin_basename( __FILE__ ) ) {
			$action_link = '<a href="'.get_admin_url().'options-general.php?page=botdetect/wp-botdetect-captcha.php">'.__('Settings').'</a>';
	...
	public function render_options_page() {
		...
		<div class="wrap">
			...
			<h2><?php _e('BotDetect CAPTCHA WordPress Plugin (v3.0.Beta1.0)', 'botdetect');?></h2>
			<p></p>
          ...
          <tr valign="top" >            
					...
					<tr valign="top">
						...
						<td>
							...
							<label><input name="botdetect_options[on_comments]" type="checkbox" value="true" <?php if (isset($options['on_comments'])) { checked($options['on_comments'], true); } ?> /> <?php _e('Wordpress Comments', 'botdetect'); ?> <em>(<?php _e('Captcha doesn\'t appear if the visitor is logged in', 'botdetect'); ?>)</em></label><br />
						</td>
					</tr>
          ...
          ?>
              ...
              <?php if ($isFree) { ?>
              <br>
              <?php _e('<i>Switching off is disabled with the Free version of BotDetect.', 'botdetect'); ?> <?php _e('<a href="http://captcha.com/doc/php/wordpress/paid-version.html">Upgrade</a> to enable.</i>', 'botdetect'); ?></span></label><br />              
              </label>
              <?php } ?>
						</td>
					</tr>
              ...
              <?php if ($isFree) { ?>
              <?php _e('<i>Not available with the Free version of BotDetect.', 'botdetect'); ?> <?php _e('<a href="http://captcha.com/doc/php/wordpress/paid-version.html">Upgrade</a> to enable.</i>', 'botdetect'); ?></span></label><br />
              <?php } else { ?>
              ...
              <?php } ?>
					...
					<tr>
						...
						<td colspan = "2">
							<p><?php _e('Additionaly: Please note almost everything is customizable by editing BotDetect\'s <a href="http://captcha.com/doc/php/howto/captcha-configuration.html">configuration file</a>.', 'botdetect'); ?></p>
						</td>
					</tr>
